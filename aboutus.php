	...
	<body>
		<div class="viewport">
			...
			<div class="main_content">
				<div class="heading">
					<div>
						<div><h2>KNOW MORE ABOUT US</h2></div>
						<div><p>MEET THE TEAM</p></div>
					</div>
				</div>
				<div class="bodyparent">
					<div class="bodymain">
						...
						<div class="content">
							<div><h1>Vision &amp; Mission</h1></div>
							<div>
								<p><b>Our Vision</b></p>
							</div>
							<hr style="width: 150px; margin: auto" />
							<div><p>To be a World Top Application</p></div>
							<div>
								<p><b>Our Mission</b></p>
							</div>
							<hr style="width: 150px; margin: auto" />
							...
							<div class="bottom">
								...
								<div class="contactwrapper">
									...
									<div class="icon_text">
										<a
											href="http://maps.google.com/?q=V01-06-01,Lingkaran SV Sunway Velocity, 55100 Kuala Lumpur"
										>
									...
									<div class="icon_text">
										<a href="mailto:info@sunway.edu.my"
											>info@sunway.edu.my</a
										>
									</div>
								</div>
							</div>
