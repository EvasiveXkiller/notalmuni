    ...
    <body class="body">
        ...
        <div class="formbox">
            <form action="loginprocessor.php" method="POST">
                ...
                <div class="buttons">
                    <input type="submit" class="loginbutton" style="height:25px;" value="Login" name="login"></input><br>
                </div>
                <p style="text-align:center"> Not a user? <a href="registerpage.php">Register here!</a></p>
            </form>
        </div>
