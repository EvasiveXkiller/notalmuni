		...
		<div class="centerbox">
			...
			<div class="registerformboxtable">
				<div class="col">
					...
					<div class="form__group field">
						<input type="tel" class="form__field" placeholder="Phone Number" name="phone" id="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required />
						<label for="phone" class="form__label">Phone Number</label>
					</div>
					<div class="form__group field">
						<input type="text" class="form__field" placeholder="Address" name="location" id="address" />
				...
				<div class="col">
					...
					<div class="form__group field">
						<input type="password" class="form__field" placeholder="Password" name="pword2" id="pword2" required />
						<label for="pword2" class="form__label">Comfirm Password</label>
					</div>
					<div class="form__group field">
						<input type="number" class="form__field" placeholder="Identity Number" name="IC" maxlength="12" id="IC" />
